...
cran_packages<- c("dplyr", "stringr", "htmlwidgets", "htmltools", "jsonlite", "bslib", "waiter", "DT", "r2d3", "networkD3", "handlr", "bibtex", "rcrossref", "RefManageR", "pdftools", "readxl", "writexl", "fs", "googledrive")
